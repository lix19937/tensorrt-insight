...
#### 
```yaml
baseline_latency_ms: 1.17725
current_profile_pattern_schemes_signature: null
config:
  verbose: true
  ...
  pattern_cache_max_entries_per_pattern: 32
patterns:
- pattern_signature: Conv[kernel_shape=7x7,pads=3x3x3x3,strides=2x2]->BatchNormalization[epsilon=1e-05]->Relu->MaxPool[kernel_shape=3x3,pads=1x1x1x1,strides=2x2]
  pattern_size: 4
  schemes:
  - latency_ms: 1.125
    error: false
    profile_timestamp: '2022-01-09T06:58:21.067394+00:00'
    nodes_insertion_points:
    - node_index: 0
      input_index: 0
    - node_index: 3
      input_index: 0
    child_region_inputs: []
    region_outputs: []
    hash: 7231d0d50aa61fe4329d2b0b6ba1a4c5
  - latency_ms: 1.13474
    error: false
    profile_timestamp: '2022-01-09T06:58:02.643696+00:00'
    nodes_insertion_points:
    - node_index: 0
      input_index: 0
    child_region_inputs: []
    ...
    - region_index: null
      node_index: 3
      output_index: 0
    hash: 5728ba9c19673819211dc765f916d009
```
