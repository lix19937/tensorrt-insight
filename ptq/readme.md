# 注意： 从 https://github.com/NVIDIA/TensorRT/tree/release/10.2/tools/pytorch-quantization 开始推荐使用model-optimizer 进行量化       
...
for implicit, TRT try to optimize the best performance, for explicit, TRT need guarantee the same accuracy as in the original framework while optimize the performance. (not work for tensorrt10.x)      
...
### [onnx quant 过程](./modpt-opt-moq.md)   
