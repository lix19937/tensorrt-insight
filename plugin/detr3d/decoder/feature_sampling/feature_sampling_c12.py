...
def main():
    ...
    bh = 72
    bw = 184
    v0=torch.rand(1,num_cam,256,bh,bw)
    v1=torch.rand(1,num_cam,256,bh//2,bw//2)
    v2=torch.rand(1,num_cam,256,bh//4,bw//4)
    v3=torch.rand(1,num_cam,256,bh//8,bw//8)
    ...
    img_shape = torch.tensor([[288,736]]) # (1,2)  LongTensor
